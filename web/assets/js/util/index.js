        ...
        if (!lang) {
            if (window.navigator) {
                ...
                const simularLangs = [
                    ...
                    ["fa", this.supportedLanguages[3].value],
                    ["si", this.supportedLanguages[2].value],  // ✅ ADD THIS
                    ["ja", this.supportedLanguages[6].value],
                    ["ru", this.supportedLanguages[7].value],
                    ["vi", this.supportedLanguages[8].value],
                    ["es", this.supportedLanguages[9].value],
                    ["id", this.supportedLanguages[10].value],
                    ["uk", this.supportedLanguages[11].value],
                    ["tr", this.supportedLanguages[12].value],
                    ["pt", this.supportedLanguages[13].value],
                ]
