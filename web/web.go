...
import (
	...
	"github.com/Thiyansa/3x-ui/v2/config"
	"github.com/Thiyansa/3x-ui/v2/logger"
	"github.com/Thiyansa/3x-ui/v2/util/common"
	"github.com/Thiyansa/3x-ui/v2/web/controller"
	"github.com/Thiyansa/3x-ui/v2/web/job"
	"github.com/Thiyansa/3x-ui/v2/web/locale"
	"github.com/Thiyansa/3x-ui/v2/web/middleware"
	"github.com/Thiyansa/3x-ui/v2/web/network"
...
func (s *Server) initRouter() (*gin.Engine, error) {
	...
	s.api = controller.NewAPIController(g, s.xrayService) // xrayService එක pass කරන්න
...
func (s *Server) Start() (err error) {
	...
	// --- ADD THIS: Ensure outbound tags are loaded and cached ---
	// This will pre-populate the outbound tags cache
	if err := s.preloadOutboundTags(); err != nil {
		logger.Warning("Failed to preload outbound tags:", err)
	}
...
// --- ADD THIS METHOD ---
// preloadOutboundTags loads outbound tags for the UI dropdown
func (s *Server) preloadOutboundTags() error {
	...
	// This just ensures the config is valid and outbounds exist
	if outbounds, ok := configMap["outbounds"]; ok {
		if outboundSlice, ok := outbounds.([]interface{}); ok {
			logger.Infof("Preloaded %d outbound tags for UI", len(outboundSlice))
		}
	}
